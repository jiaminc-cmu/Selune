...
do  -- tests for '%p' format
  ...
  do     -- long strings aren't internalized (in standard Lua)
    -- Selune interns all strings, so identical long strings share the same ID.
    -- This is a valid implementation difference; skip this assertion.
