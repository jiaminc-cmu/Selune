...
pub struct StdlibIndices {
    ...
    pub debug_sethook_idx: GcIdx<NativeFunction>,
    pub debug_gethook_idx: GcIdx<NativeFunction>,
    pub debug_getlocal_idx: GcIdx<NativeFunction>,
    pub debug_setlocal_idx: GcIdx<NativeFunction>,
    pub debug_getregistry_idx: GcIdx<NativeFunction>,
    pub coro_running_idx: GcIdx<NativeFunction>,
    pub coro_isyieldable_idx: GcIdx<NativeFunction>,
    pub coro_close_idx: GcIdx<NativeFunction>,
...
pub fn register_all(
    ...
    StdlibIndices {
        ...
        debug_sethook_idx: debug_indices.sethook_idx,
        debug_gethook_idx: debug_indices.gethook_idx,
        debug_getlocal_idx: debug_indices.getlocal_idx,
        debug_setlocal_idx: debug_indices.setlocal_idx,
        debug_getregistry_idx: debug_indices.getregistry_idx,
        coro_running_idx: coro_indices.running_idx,
        coro_isyieldable_idx: coro_indices.isyieldable_idx,
        coro_close_idx: coro_indices.close_idx,
